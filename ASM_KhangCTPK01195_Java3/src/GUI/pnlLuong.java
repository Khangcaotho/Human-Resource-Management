 ...
 * @author KhangCao
 */
public class pnlLuong extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblLuong.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Lương Cơ Bản", "Lương Thưởng", "Mã Lương"
            }
        ));
        ...
        scpNhanVien.setViewportView(tblLuong);
        if (tblLuong.getColumnModel().getColumnCount() > 0) {
            tblLuong.getColumnModel().getColumn(0).setMinWidth(10);
            tblLuong.getColumnModel().getColumn(0).setPreferredWidth(10);
        }
        ...
        lblTenNhanVien.setText("Lương Cơ Bản :");

        lblDiaChi.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        lblDiaChi.setText("Lương Thưởng :");
        ...
        lblQuanLyPhongBan.setText("Quản Lý Lương");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtLuongThuong, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(40, 40, 40))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lblDiaChi)
                        .addComponent(txtLuongThuong, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemActionPerformed
     ...
     boolean kq = BLL.BLLLuong.KiemTra(LuongCB,LuongThuong);
            if (kq) {
            BLL.BLLLuong.LayDuLieu(tblLuong);
        }
    }//GEN-LAST:event_btnthemActionPerformed

    private void btntkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntkActionPerformed
        String tuKhoa = txttimkiem.getText();
        BLL.BLLLuong.TimDuLieu(tblLuong, tuKhoa);
      ...
      int kq = JOptionPane.showConfirmDialog(new JFrame(), "Bạn có chắc chắn xóa không?", "Thông báo xác nhận",JOptionPane.YES_NO_OPTION);
        if(kq == JOptionPane.YES_OPTION){
            ...
            for(int i = cacdong.length-1; i >= 0; i--){
               String MaLuong = tblLuong.getValueAt(cacdong[i],3).toString();
               DAO.DAOLuong.Delete(MaLuong);
            }
            BLL.BLLLuong.LayDuLieu(tblLuong);
        }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        int soDongDuocChon = tblLuong.getSelectedRowCount();
        if(soDongDuocChon < 1){
            ...
            String LuongCB = txtLuongCB.getText();
            String LuongThuong = txtLuongThuong.getText();
            int viTri=tblLuong.getSelectedRow();
            String maLuong = tblLuong.getValueAt(viTri,3).toString();
            boolean kq = BLL.BLLLuong.KiemTraSua(LuongCB,LuongThuong,maLuong);
            if (kq) {
            BLL.BLLLuong.LayDuLieu(tblLuong);
        }
    ...
    private void tblLuongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLuongMouseClicked
         if(tblLuong.getSelectedRowCount()>=1){
        ...
        if(tblLuong.getSelectedRowCount()>=1){
            ...
            // lấy vị trí đc chọn
            int viTri = tblLuong.getSelectedRow();
            txtLuongCB.setText(tblLuong.getValueAt(viTri,1).toString());
            txtLuongThuong.setText(tblLuong.getValueAt(viTri, 2).toString());
        }else{ 
